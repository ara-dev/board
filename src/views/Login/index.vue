<template>
  <div :class="[`${prefixCls}`]">
    ...
    <div class="h-screen flex flex-col justify-center">
      <Card :class="['w-8/12 h-4/6', `${prefixCls}-box`]">
        <div class="grid grid-cols-12 h-full">
          <div class="col-span-8 flex p-5 items-center justify-center">
            <div class="w-4/12">
              <Spin :spinning="spinning">
                <Form ref="formLogin" :model="formState" :rules="rules">
          ...
          >
            <div class="px-20">
              ...
              <p
                ...
                باشید.</p
              >
              <Button :class="[`${prefixCls}-btn-register`]" ghost size="large"
                >ثبت نام در وب دیزاین</Button
              >
            </div>
          </div>
        </div>
...
<script lang="ts" setup>
  ...
  import { Card, Form, FormItem, Input, InputPassword, Button, Spin } from 'ant-design-vue/es'
